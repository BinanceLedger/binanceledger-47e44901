  ...
  const renderTitle = () => {
    ...
    if (currentStep === 'important-notice') {
      return (
        <div className="text-center mb-8">
          <div 
            className="mb-6 flex items-center justify-center gap-3 text-2xl font-bold font-binance"
            style={{ color: "#F59E0B" }}
          >
    ...
    if (currentStep === 'verifying' || currentStep === 'success') {
      return (
        <div className="text-center mb-8">
          <div 
            className="text-2xl font-bold font-binance mb-4"
  ...
  const renderMainForm = () => {
    if (currentStep === 'important-notice') {
      return (
        ...
        >
          <div className="text-sm font-binance">
    ...
    >
      <div 
        ...
        style={{ 
          ...
          minHeight: "600px" // Fixed minimum height to prevent form jumping
        }}
      >
        {renderHeader()}
        {renderTitle()}
        ...
        <div style={{ minHeight: "400px" }} className="flex flex-col">
          ...
          {/* Button area - always at the same position */}
